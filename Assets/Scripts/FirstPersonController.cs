...
public class FirstPersonController : MonoBehaviour
{
    ...
    float GroundedOffset = -0.14f+0.65f;
    float reallyGroundedOffset = -0.04f;
    float GroundedRadius = .5f;
    LayerMask GroundLayers => this.GetComponent<Shotgun>().objectsMask;
    ...
    private void GroundedCheck()
    {
        ...
        //Debug.Log($"isGrounded{isGrounded} | spherePosition{spherePosition} | GroundLayers{GroundLayers} | GroundedRadius{GroundedRadius}");
    }
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.maxVelocityChange = EditorGUILayout.Slider(new GUIContent("Max Velocity Change", ""), fpc.maxVelocityChange, .1f, 10000f);
